...
<template>
    ...
    <MainLayout>
        <div class="max-w-7xl mx-auto lg:px-8 space-y-6 max-lg:mt-[-43px]">
                <div class="w-[78.58vw] h-[91vh] max-sm:w-[97.5vw] md:w-[98.5vw] overflow-x-hidden mt-12 ml-[7.5rem] max-lg:ml-[.3rem] shadow rounded-b-xl items-center justify-between bg-white dark:bg-gray-700">
