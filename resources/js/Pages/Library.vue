...
<template>
    ...
    <MainLayout>
        <div class="max-w-7xl mx-auto lg:px-8 space-y-6 max-lg:mt-[-43px]">
                <div class="w-[78.58vw] h-[91vh] overflow-x-hidden max-sm:w-[97.5vw] md:md:max-lg:w-[98.8vw] md:md:max-lg:h-[94vh] mt-12 ml-[7.5rem] max-sm:ml-[.3rem] md:md:max-lg:ml-[.3rem] shadow rounded-b-xl items-center justify-between bg-white dark:bg-gray-700">
